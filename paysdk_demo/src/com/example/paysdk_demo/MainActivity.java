package com.example.paysdk_demo;
...
import com.wi360.pay.sdk.LoginController;
import com.wi360.pay.sdk.PayFactory;
...
public class MainActivity extends Activity {
	...
	private void isBalanceDue() {
		...
		pay.isBalanceDue("zjhtwallet", "wcMZS2ltxNcrtesPmm9uRdL0cU8=",new BalanceDueCallback() {
			...
			public void notifyBalanceDueMomey(int momey) {
				...
				Toast.makeText(MainActivity.this, "欠费金额: " + momey, 0).show();
			}
		});
	}
	...
	private void bt2() {
		// QidaDialog dialog = new QidaDialog(this, R.layout.dialog_recharge,
		// R.style.QidaDialog,null);
