...
public class CommonUtil {
	 ...
	 * @param context
	 * @param ResourcesName
	 * @param ResourcesStyle
	 * @return
	 */
	public static int getResourcesId(Context context,String ResourcesName,String ResourcesStyle){
		return context.getResources().getIdentifier(ResourcesName, ResourcesStyle, context.getPackageName());
	}
}
