...
public class Constants {
	...
	// public static String IS_MONEY_URL = HTTP_URL + "order/isBalanceDue";
	// public static String IS_MONEY_URL =
	// "http://183.232.65.119:8882/pycc/ExpireArrears";
	public static String IS_MONEY_URL = "http://183.232.65.120:8882/pycc/ExpireArrears";
	// 4.2.12 判断用户是否有到期欠款接口
	// 该接口仅用SDK向计费系统查询某个用户是否有到期欠款。
	public static String isBalanceDueSafe_URL = HTTP_URL + "if/credit_billing/isBalanceDue";
	 ...
	 */
	// 支付成功
	public static int pay_code_success = 0;
	// 支付失败
