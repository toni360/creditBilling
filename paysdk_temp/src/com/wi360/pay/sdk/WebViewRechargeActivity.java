...
public class WebViewRechargeActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		int layout_id = CommonUtil.getResourcesId(this, "layout_web_view_recharge", "layout");
		int web_id = CommonUtil.getResourcesId(this, "web_view", "id");
		setContentView(layout_id);
		webView = (WebView) findViewById(web_id);
