...
public class HttpUtils {
	 ...
	 * @return 所代表远程资源的响应结果
	 */
	public static void sendPost(String url, String json, MyRequestCallBack2 myRequestCallBack2) {
		...
		try {
			...
			Log.i(TAG, "response json: " + result);
			myRequestCallBack2.onSuccess(200, result);
		} catch (Exception e) {
			System.out.println("发送 POST 请求出现异常！" + e);
			myRequestCallBack2.onFailure(e, "发送 POST 请求出现异常！");
			e.printStackTrace();
		} finally {
			/** 使用finally块来关闭输出流、输入流 **/
			try {
