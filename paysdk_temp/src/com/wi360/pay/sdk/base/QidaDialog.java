...
public class QidaDialog extends Dialog {
	...
	public QidaDialog(Activity context) {
		super(context);
		this.context = context;

	}

	public QidaDialog(Activity context, int layout_id, int theme, ResponseCallback responseCallback) {
		super(context, theme);
		this.context = context;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.mTitle = (TextView) view.findViewById(CommonUtil.getResourcesId(context, "tv_title", "id"));
		// this.mContent = (TextView) this.findViewById(R.id.content);
		// this.mOkBtn = (Button) this.findViewById(R.id.dialog_button_ok);
		this.mCancleBtn = (Button) this.findViewById(CommonUtil.getResourcesId(context, "bt_cancel", "id"));
